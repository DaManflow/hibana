...
class Controller_former_list_moderator extends Controller{
    
    public function action_former_pagination_moderator() {
        ...
        if (isset($_GET['start'])) {
            if (preg_match("/^[1-9]\d*$/", $_GET['start'])) {
                ...
                if ($pages == 0) {
                    $data = [
                                    'title' => 'Message Page',
                                    'message' => "Il n'y pas de formateur hors modérateurs !"
                                ];
                ...
                $_GET['start'] = 1;
                header("Location: ?controller=former_list_moderator&action=former_pagination_moderator&start=" . $_GET['start']);
            }
    ...
    public function action_default(){
        $this->action_former_pagination_moderator();
    }
