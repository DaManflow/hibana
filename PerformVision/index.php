...
$controllers = ["home", "register_customer","register_former","choice", "former_list", "home_former", "home_customer", "profil_customer", "profil_former", "login", "logout", "list","register_redirection"];
