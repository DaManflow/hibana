...
echo '<a href="?controller=admin_list&action=admin_pagination&start='.($page - 1).'"><img src="./Content/images/previous-icon.png" class="icone" /></a>';

        for($i = 1; $i <= $pages; $i++){
            if($page!=$i){
                echo "<a class='lienStart' href='?controller=admin_list&action=admin_pagination&start=$i'>$i</a>&nbsp;";
            }else{
        ...
        echo '<a href="?controller=admin_list&action=admin_pagination&start='.($page + 1).'"><img src="./Content/images/next-icon.png" class="icone" /></a>';
