...
<div class="debut">
    <div class="partie-gauche"><a href="?controller=home&action=home">PerformVision Training & Consulting</a></div>
    <div class="partie-droite">
        ...
        <ul class="dropdown">
        <ul><a href="?controller=home&action=home" id="link">Formateurs</a></ul>
        </ul>
</li>
